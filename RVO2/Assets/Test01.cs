...
public class Test01 : MonoBehaviour {
    ...
    void Start () {
        ...
        // 创建小球
        Simulator.Instance.setAgentDefaults(10.0f, 10, 1f, 1.1f, 0.5f, speed, new RVO.Vector2(0.0f, 0.0f));
    ...
    void CreateGameObject(Vector3 position, GameObject spherePrefab, float radius) {
        Simulator.Instance.setAgentDefaults(10.0f, 10, 1f, 1.1f, radius / 2f, speed , new RVO.Vector2(0.0f, 0.0f));
        // orca
